...
exports.sendBookingOTP = async (req, res) => {
    try {
        ...
        try {
            ...
            return res.status(500).json({ message: 'OTP created but the email could not be sent. Check server email configuration.' });
        }
...
exports.confirmBooking = async (req, res) => {
    try {
        ...
        // Send email on admin confirmation - don't let a failed email undo the
        // booking confirmation that's already been saved
