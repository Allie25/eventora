    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!showOTP) {
                ...
                const data = await register(trimmedName, trimmedEmail, password);
                setShowOTP(true);
                setEmail(trimmedEmail);
                setError(data?.emailFailed
                    ? 'Account created, but the OTP email failed to send. Please contact support or try again later.'
                    : '');
            } else {
